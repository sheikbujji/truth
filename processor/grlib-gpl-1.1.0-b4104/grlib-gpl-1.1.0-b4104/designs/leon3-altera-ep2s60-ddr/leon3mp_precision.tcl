...
setup_design -manufacturer Altera -family StartixII -part EP2S60F672C -package F672C -speed -3
set_input_dir .
...
add_input_file -format VHDL -work techmap ../../lib/techmap/stratixii/grusbhc_stratixii.vhd
...
add_input_file -format VHDL -work work smc_mctrl.vhd
